...
newaction {
    ...
    execute = function()
        ...
        while (_ARGS[index] ~= nil) do
            ...
            elseif (arg == ("-b" or "--build")) then
                print("Cleaning Build")

                os.rmdir("./Build")

            elseif (arg == ("-E" or "--Engine" or "--engine")) then
            ...
            elseif (arg == ("-h" or "--help")) then
                print(description)

            elseif (arg == ("-t" or "--test")) then
                print("Cleaning Test")
