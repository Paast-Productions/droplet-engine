...
class Component;
/**
 * @brief Represents an gameobject in a scene hierarchy.
 *
...
public:
    ...
    */
    ...
    /**
     * @brief does nothing, should probably not be here
     */
    virtual void Render();
    ...
    *
    * Searches the Components attached to this Node and returns the
    * first Component that can be cast to the requested type.
    *
    * @tparam T Type of Component to search for.
    *
    * @return A shared pointer to the Component, or nullptr if no
    *         Component of the requested type was found.
    */
    template<typename T>
