...
namespace Droplet::MetaSerializer
{
    ...
    bool Read(const std::filesystem::path &p_metaFilePath, std::vector<ResourceMetaData> &p_metaData);
    ...
    bool Write(const std::filesystem::path &p_metaFilePath, std::vector<ResourceMetaData> &p_metaData);
    ...
    bool GenerateDefaultMetaFile(const std::filesystem::path &p_assetPath, std::vector<ResourceMetaData> &p_metaData);
}