...
uint32_t FindMemoryType
	(const vk::raii::PhysicalDevice& p_physDevice, uint32_t p_typeFilter, vk::MemoryPropertyFlags p_properties);
...
std::pair<vk::raii::Buffer, vk::raii::DeviceMemory> CreateBuffer
	(const vk::raii::Device &p_device, const vk::raii::PhysicalDevice &p_physDevice, vk::DeviceSize p_size, vk::BufferUsageFlags p_usage, vk::MemoryPropertyFlags p_properties);
...
vk::raii::CommandBuffer BeginSingleTimeCommands
	(const vk::raii::Device &p_device, const vk::raii::CommandPool &p_commandPool);
...
void EndSingleTimeCommands
	(vk::raii::CommandBuffer &&p_commandBuffer, const vk::raii::Queue &p_queue);
...
void CopyBuffer
	(const vk::raii::Device &p_device, const vk::raii::Queue &p_queue, const vk::raii::CommandPool &p_commandPool, const vk::raii::Buffer &p_srcBuffer, const vk::raii::Buffer &p_dstBuffer, vk::DeviceSize p_size);